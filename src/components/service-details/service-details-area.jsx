...
const service_details_content = {
  ...
  info_1: (
    <>
      CCTV stands for closed-circuit television. So how does a modern CCTV
      system work? The answer depends on the type of system involved. The
      systems are best defined by the types of cameras used. There are two
      common types of cameras in use today: Analog and IP-based cameras.
    </>
  ),
  info_2: (
    <>
      CCTV, also known as closed-circuit television, is a security monitor
      system that enables you to always keep a watchful eye around or in your
      business. CCTV security systems contain monitors and cameras that allow
      you to view live events, as well as recorders that archive footage for
      later use. A CCTV is a video surveillance system that is placed in
      security cameras to help record images and videos in a home, business
      property, & even on the roads. The camera works by monitoring, recording
      video images and transmitting them to a monitor. A CCTV is therefore used
  ...
  overview: (
    <>
      A CCTV is a video surveillance system that is placed in security cameras
      to help record images and videos in a home, business property, & even on
      the roads. The camera works by monitoring, recording video images &
      transmitting them to a monitor. A CCTV is therefore used primarily for
      security purposes
    </>
  ),
  ...
  bottom_info: (
    <>
      The difference between CCTV and standard TV is that standard TV openly
      broadcasts signals to the public. In contrast, CCTV broadcasts are not
      sent to the public. CCTV uses either a wired or wireless transmission to
      transmit the broadcast from the video cameras to the monitor(s) or
      recording device.
    </>
  ),
